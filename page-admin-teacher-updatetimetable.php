				...
				<section class="container">
					...
					<div class="row">
						...
						<div class="col-md-4">
							...
							<form class="white-row" method="post" action="page-admin-update-teacher-tt.php?id=<?php echo $id; ?>">
								<?php
								...
								<div class="row">
									<div align="center">
										<a href="page-admin-teacher-details.php?id=<?php echo $id; ?>" class="btn btn-primary">Back</a>

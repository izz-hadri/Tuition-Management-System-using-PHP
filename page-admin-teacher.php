...
<html>
	<head>
		...
		<meta charset="utf-8" />
		<title>Admin Page-Teacher</title>
	...
	<body background="assets/images/coverpage4.jpg">
		...
		<div id="wrapper">
			...
			<section id="" class="padding60">
				<h2 align="center"><b>List Of Teacher</b></h2>
				<div class="container">
					<div class="col-md-4"></div>
					<div class="col-md-4">
						<form name="form-admin-teacher-search" action="search-teacher.php" method="post">
				...
				<div align="center" class="container">
					<table border="2" id="tablestyle">
                       ...
                       $sql = "SELECT `tcr_id`, `tcr_name` FROM `teacher`";
                     ...
                     Print '<tr>
                        <td>'.$row['tcr_id'].'</td>
                        <td>'.$row['tcr_name'].'</td>
                        <td><a href="page-admin-teacher-details.php?id='.$row['tcr_id'].'">Details</a></td>
                        <td><a onclick="javascript:confirmationDelete($(this));return false;" href="page-admin-teacher-delete.php?id='.$row['tcr_id'].'">Delete</a></td>
                     </tr>';
                   }
                ?>
					</table>

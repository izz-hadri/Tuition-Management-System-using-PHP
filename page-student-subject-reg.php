	...
	<body background="assets/images/coverpage4.jpg">
		...
		<div id="wrapper">
			...
			<section id="" class="padding60">
				...
				<div class="container">
					<div align="center">
						<form name="subject-registration-form" action="student-subject-reg.php?id=<?php echo $id;?>" method="post">
							<select name="subject">
		                       ...
		                       print '<option value="'.$row['subject_code'].'">'.$row['subject_name'].'</option>';}
		                       ?>
					...
					<div align="center">
						<table border="2" id="tablestyle">
							...
							<?php
		                       ...
		                       $sql = "SELECT S.stu_id, P.subject_code, subject_name , subject_price FROM student S, subject P , learn L WHERE S.stu_id = L.stu_id AND L.subject_code = P.subject_code AND S.stu_id='$id'";
		                       $count=0;
		                       $result = mysqli_query($db, $sql);
		                       ...
		                       print '<tr>
		                       		...
		                       		<td><a href="student-delete-subject.php?id='.$id.'&code='.$row['subject_code'].'">Drop</a></td>
		                       </tr>
		                       ';
								$count = $count + $row['subject_price'];
		                   }

		                       ?>
								<tr>
									<th>Total Price (RM)</th>
									<td colspan="3" style="text-align: left;"><?php echo $count; ?></td>
								</tr>
						</table>
					</div>
				</div>

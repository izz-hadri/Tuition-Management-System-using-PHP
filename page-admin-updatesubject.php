					...
					<div class="row">
                       ...
                       while($row = mysqli_fetch_assoc($result)){
                       	?>
							...
							<h2 align="center"><b>Add Subject</b></h2>

							<form class="white-row" method="post" action="updateSubject.php">
								
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											<label>Subject Code</label>
											<input type="text" name="subcode" class="form-control" value="<?php echo $row['subject_code'];?>">
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											...
											<input type="text" name="subname" class="form-control" value="<?php echo $row['subject_name'];?>">
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											...
											<input type="text"name="submodule" class="form-control" value="<?php echo $row['subject_module'];?>">
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											...
											<input type="text" name="subprice" class="form-control" value="<?php echo $row['subject_price'];?>">
										</div>
									</div>
								</div>
								<div class="row">

...
<html>
	<head>
		<?php $id = $_GET['id'];?>
		<meta charset="utf-8" />
		<title>Page-Student-Update</title>
					...
					<div class="row">
						...
						<!-- LOGIN -->
		                    ...
		                    $result = mysqli_query($db, $sql);
		                   	...
		                   	?>
							<h2 align="center"><b>Update Student's Details</b></h2>

							<form class="white-row" method="post" action="page-student-update1.php?id=<?php echo $id;?>">
								<div class="col-md-6">
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												Full Name<input type="text" name="stdname" class="form-control" value="<?php echo $row['stu_name']; ?>">
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												IC Number<input type="text" name="stdic" class="form-control" value="<?php echo $row['stu_ic']; ?>" >
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												<div class="col-md-6">
													...
													<option  value="<?php echo $row['stu_sex']; ?>"><?php echo $row['stu_sex']; ?></option>
												...
												<div class="col-md-6">
													Category<br>
													<select name="stdcategory">
													<option  value="<?php echo $row['stu_category'];?>"> <?php echo $row['stu_category']; ?> </option>
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												Email<input type="text" name="stdemail" class="form-control" value="<?php echo $row['stu_email']; ?>">
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												Address<textarea name="stdaddress" class="form-control"><?php echo $row['stu_address']; ?></textarea>
											</div>
										</div>
									</div>
								</div>
								<div class="col-md-6">
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												Phone Number<input type="text" name="stdphone" class="form-control" value="<?php echo $row['stu_phone_num']; ?>">
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												Parent Phone Number<input type="text" name="stdtel" class="form-control" value="<?php echo $row['stu_parent_phone_num']; ?>">
											</div>
										</div>
									</div>
								...
								<div class="row">
									<div align="center"><br>
										...
										<a href="page-student-details.php?id=<?php echo $id;?>" class="btn btn-primary">Back</a>

...
<html>
	<head>
		<meta charset="utf-8" />
		<?php $id = $_GET['id'];?>
		<title>Page-Teacher-Timetable</title>
	...
	<body background="assets/images/coverpage4.jpg">
				...
				<div class="navbar-collapse nav-main-collapse collapse pull-right">
					<nav class="nav-main mega-menu">
						<ul class="nav nav-pills nav-main scroll-menu" id="topMain">
							<li><a href="page-teacher-details.php?id=<?php echo $id;?>">Teacher Details</a></li>
							<li class="active"><a href="page-teacher-timetable.php?id=<?php echo $id;?>">Timetable</a></li>
		...
		<div id="wrapper">
			...
			<section id="" class="padding60">
				<h2 align="center"><b>Timetable</b></h2>
				<div class="container">
					<table id="tablestyle">
						<tr>
							<th>Subject Code</th>
						...
						while ($row=mysqli_fetch_assoc($result)) {
							print '<tr>
								...
								<td>'.$row['timetable_day'].'</td>
								<td>'.$row['timetable_session'].'</td>
								</tr>
							';
						}
						?>

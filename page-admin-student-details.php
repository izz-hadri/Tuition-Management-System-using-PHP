		...
		<div id="wrapper">
			...
			<section id="" class="padding60">
				...
				?>
					<div align="center">
						<br>
						<a href="page-admin-student.php" class="btn btn-primary">Back</a>
						<a href="page-admin-student-timetable.php?id=<?php echo $id; ?>" class="btn btn-primary">View Timetable</a>
						<a href="page-admin-student-updatetimetable.php?id=<?php echo $id; ?>" class="btn btn-primary">Update Timetable</a>
					</div>
				</div>
				<br>

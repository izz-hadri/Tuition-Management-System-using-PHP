...
<html>
	<head>
		<meta charset="utf-8" />
		<?php $id = $_GET['id']; ?>
		<title>Admin Page-Student-Details</title>
				...
				<section class="container">
					...
					<div class="row">
						...
						<div class="col-md-4">
							...
							<h2 align="center"><b>Timetable Form</b></h2>

							<form class="white-row" method="post" action="page-admin-update-student-tt.php?id=<?php echo $id; ?>">
								<?php
								include "dbconnect.php";
								$sql = "SELECT * FROM learn WHERE stu_id='$id'";
									...
									<div class="col-md-12">
										<div class="form-group" >
											...
											<select name="subcode">
												...
												print '<option value="'.$row['subject_code'].'">'.$row['subject_code'].'</option>';
											} ?>
											</select>
										</div>
									</div>
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											<label>Timetable Day</label><br>
											<select name="subtimetableday">
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											<label>Timetable Session</label><br>
											<select name="subtimetableday1">
												<option value="">Choose Session</option>
												<option value="9.00 a.m-10.00 a.m">Session 1 (9.00 a.m-10.00 a.m)</option>
												<option value="10.00 a.m-11.00 a.m">Session 2 (10.00 a.m-11.00 a.m)</option>
												<option value="8.00 p.m-9.00 p.m">Session 3 (8.00 p.m-9.00 p.m)</option>
												<option value="9.00 p.m-10.00 p.m">Session 4 (9.00 p.m-10.00 p.m)</option>
											</select>
										</div>
									</div>
								</div>
								<div class="row">
									<div align="center">
										<a href="page-admin-student-details.php?id=<?php echo $id; ?>" class="btn btn-primary">Back</a>
										<input type="submit" name="Update Timetable" value="Submit" class="btn btn-primary">
									</div>
								</div>
								<div class="col-md-4"></div>
							</form>
